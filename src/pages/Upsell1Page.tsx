...
import { Brain, Activity, Shield, Repeat, AlertTriangle } from 'lucide-react';

const Upsell1Page: React.FC = () => {
    return (
        <MemberLayout>
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mb-12 text-center md:text-left">
                    <div className="inline-flex items-center gap-2 bg-brand-red/10 text-brand-red px-4 py-1.5 rounded-full text-sm font-bold mb-6 border border-brand-red/20">
                        <AlertTriangle className="w-4 h-4" /> Programa Avançado
                    </div>
                    ...
                    <p className="text-xl text-brand-muted max-w-3xl leading-relaxed">
                        Bem-vindo ao seu novo padrão emocional. Aqui você vai eliminar de vez o mecanismo que dispara a vontade de doce e parar de viver apagando incêndio.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <ContentCard
                        title="Módulo 2: Protocolo de Reprogramação"
                    ...
                    <ContentCard
                        title="Módulo 3: Técnicas de Ruptura"
                    ...
                    <ContentCard
                        title="Módulo 4: Plano Anti-Recaída"
