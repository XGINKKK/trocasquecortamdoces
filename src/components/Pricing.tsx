...
const Pricing: React.FC = () => {
    ...
    const handleAcceptDiscount = () => {
        ...
        // Logic to redirect to checkout with discount
            ...
            <div className="container mx-auto max-w-5xl px-4">
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8 md:items-stretch">
                    ...
                    >
                        ...
                        <Button variant="primary" size="lg" fullWidth className="animate-pulse-slow bg-gradient-to-r from-brand-red to-brand-darkRed border-none">
